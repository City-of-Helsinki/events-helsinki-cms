...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        collection_hero_image = models.CustomImage(title='Collection Hero Image', file='collection_hero_image.jpg')
        ...
        hero_background_image = models.CustomImage(title='Landing Page Hero Background Image', file='landing_page_hero_background_image.jpg')
        ...
        hero_top_layer_image = models.CustomImage(title='Landing Page Hero Top Layer Image', file='landing_page_hero_top_layer_image.jpg')
        ...
        social_media_image = models.CustomImage(title='Landing Page Social Media Image', file='landing_page_social_media_image.jpg')
